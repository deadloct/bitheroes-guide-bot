...
_Guide Authors_: a_poor_ninja, Adhesive81, Antomanz, Ballbreaker, BillyIdol, Chocomint, ChubbyDaemon, Crow, CyberMuffin, DarkHand6, Dispel1, Ember, Fyra, Goku, Gylgymesh, Hæl (aka Hael in this bot), Huen11, iWushock, Jermoshua, JoeBu, josiah_4, kruste, McSploosh, Orcaaa, PAINisGOD93, RoastyChicken, ShawnBond, Sizz, Smolder, Special_Delivery, Techno, Tolton, VesaN, WRLD_EATR, Youreprettycute, and ZombieSlayer13
