...
_Guide Authors_: a_poor_ninja, Adhesive81, Antomanz, Ballbreaker, BillyIdol, Chocomint, ChubbyDaemon, Crow, CyberMuffin, DarkHand6, Dispel1, Ember, Fyra, Goku, Gylgymesh, Hæl (aka Hael in this bot), Huen11, iWushock, Jermoshua, JoeBu, josiah_4, kruste, McSploosh, PAINisGOD93, ShawnBond, Sizz, Smolder, Techno, Tolton, VesaN, Youreprettycute, and ZombieSlayer13
